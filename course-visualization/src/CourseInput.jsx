  ...
  useEffect(() => {
    const loadCourses = async () => {
      try {
        ...
        const response = await fetch(coursesFile);
        if (!response.ok) {
    ...
    <div className="relative w-full max-w-[1200px] mx-auto">
      ...
      >
        <button
          ...
          className={`px-4 py-2 rounded-md font-semibold transition ${useSemanticSearch ? "bg-[#3f1f69] text-white" : "bg-gray-200 text-black"
            }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 rounded-md font-semibold transition ${useAllSemestersSearch ? "bg-[#3f1f69] text-white" : "bg-gray-200 text-black"
            }`}
        >
